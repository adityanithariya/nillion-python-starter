...
async def main():
    ...
    new_secret = nillion.NadaValues(
        {
            "cyringe_base_price": nillion.SecretInteger(100),
            "supplier_hospital_margin": nillion.SecretInteger(10),
            "supplier_medical_margin": nillion.SecretInteger(15),
        }
    )
    ...
    compute_bindings.add_input_party(supplier, party_id)
    compute_bindings.add_input_party(hospital, party_id)
    compute_bindings.add_input_party(medical_shop, party_id)
    compute_bindings.add_output_party(customer, party_id)

    # Add my_int2, the 2nd secret at computation time
    computation_time_secrets = nillion.NadaValues({
      "hospital_margin": nillion.SecretInteger(5),
      "medical_margin": nillion.SecretInteger(10),
    })
